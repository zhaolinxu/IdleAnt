...
var BaseWorld = (function () {
    ...
    BaseWorld.prototype.declareMaterials = function () {
        ...
        this.crystal = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "cri", "Crystal", "Crystals are needed to get science.");
        this.listMaterial.push(this.crystal);
        this.soil = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "soil", "Soil", "Soil is used to make nests.");
        this.listMaterial.push(this.soil);
        this.science = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "sci", "Science", "Science is used to improve and unlock stuff.");
        this.listMaterial.push(this.science);
        this.fungus = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "fun", "Fungus", "Fungus is a source of food.");
        this.listMaterial.push(this.fungus);
        this.wood = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "wood", "Wood", "Wood is used to make better nest and machinery.");
        this.listMaterial.push(this.wood);
        this.sand = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "sand", "Sand", "Sand can be used to make crystals.");
        this.listMaterial.push(this.sand);
        this.nectar = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "nectar", "Nectar", "Nectar is used to make honey.");
        this.listMaterial.push(this.nectar);
        this.honey = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "honey", "Honey", "Honey is the main resource for bees.");
    ...
    BaseWorld.prototype.declareGenerators = function () {
        this.littleAnt = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "G1", "Ant", "Ant are the lowest class of worker. They continuously gather food.");
        this.queenAnt = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "G2", "Queen", "Queen produces ants.");
        this.nestAnt = new __WEBPACK_IMPORTED_MODULE_1__units_unit__["a" /* Unit */](this.game, "G3", "Nest", "Nest produces queen.");
    };
